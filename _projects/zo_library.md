...
An open-source PyTorch-style library for zeroth-order optimization, enabling memory-efficient fine-tuning with up to **50% memory reduction**. Implements SignSGD, Muon, and all novel momentum-based ZO methods.
