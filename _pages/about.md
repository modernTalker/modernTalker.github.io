...
Currently, I am a PhD student at **Columbia University**, in the **DAP Lab**, advised by [Eugene Wu](https://scholar.google.com/citations?user=X53rkecAAAAJ) and [Kostis Kaffes](https://scholar.google.com/citations?user=swf47vcAAAAJ). I work on **post-training efficiency**: the **optimization dynamics of RL post-training (RLVR)**, that is, how optimizer behavior and the loss landscape change relative to pretraining, and **staleness mitigation for asynchronous post-training** with parallel rollout generation, where algorithms and systems have to be co-designed to keep GPUs busy.
